...
--
-- Host: localhost    Database: modx2018
-- ------------------------------------------------------
...
CREATE TABLE `modx_access_policies` (
  ...
  `template` int(10) unsigned NOT NULL DEFAULT '0',
  `class` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `data` text COLLATE utf8_unicode_ci,
  `lexicon` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'permissions',
  PRIMARY KEY (`id`),
...
CREATE TABLE `modx_actiondom` (
  ...
  `action` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `name` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `description` text COLLATE utf8_unicode_ci,
  `xtype` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `container` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `rule` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `value` text COLLATE utf8_unicode_ci NOT NULL,
  `constraint` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `modx_actions` (
  ...
  `controller` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `modx_actions_fields` (
  ...
  `tab` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `form` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `other` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `rank` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `action` (`action`),
  KEY `type` (`type`),
...
CREATE TABLE `modx_class_map` (
  ...
  `name_field` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'name',
  `path` tinytext COLLATE utf8_unicode_ci,
  `lexicon` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'core:resource',
  PRIMARY KEY (`id`),
...
CREATE TABLE `modx_context_resource` (
  `context_key` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `modx_context_setting` (
  ...
  `area` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `modx_dashboard_widget` (
  ...
  `namespace` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `lexicon` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'core:dashboards',
  `size` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'half',
  PRIMARY KEY (`id`),
  KEY `name` (`name`),
  KEY `type` (`type`),
  KEY `namespace` (`namespace`),
...
CREATE TABLE `modx_extension_packages` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `namespace` varchar(40) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'core',
  `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'core',
  `path` text COLLATE utf8_unicode_ci,
  `table_prefix` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `service_class` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `service_name` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `modx_lexicon_entries` (
  ...
  `name` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `value` text COLLATE utf8_unicode_ci NOT NULL,
  `topic` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'default',
  `namespace` varchar(40) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'core',
...
CREATE TABLE `modx_manager_log` (
  ...
  `item` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
INSERT INTO `modx_manager_log` VALUES (1,1,'2018-11-09 01:03:56','login','modContext','mgr');
...
CREATE TABLE `modx_menus` (
  `text` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `parent` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `action` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `modx_session` (
  `id` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
INSERT INTO `modx_session` VALUES ('ip0hst4lv6ee7evfgqbctpg4m9',1541725436,'modx.user.contextTokens|a:1:{s:3:\"mgr\";i:1;}modx.mgr.user.token|s:52:\"modx5be4dcef027791.45375622_15be4dcfca82d59.55580577\";modx.mgr.session.cookie.lifetime|i:0;modx.mgr.user.config|a:0:{}');
...
CREATE TABLE `modx_site_content` (
  ...
  `pagetitle` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `longtitle` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `description` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(191) COLLATE utf8_unicode_ci DEFAULT '',
  `link_attributes` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  `menutitle` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `modx_site_htmlsnippets` (
  ...
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `description` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Chunk',
  ...
  `static_file` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
  KEY `category` (`category`),
  KEY `locked` (`locked`),
...
CREATE TABLE `modx_site_plugin_events` (
  ...
  `event` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `modx_site_templates` (
  ...
  `description` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Template',
  `editor_type` int(11) NOT NULL DEFAULT '0',
  `category` int(11) NOT NULL DEFAULT '0',
  `icon` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `modx_transport_packages` (
  ...
  `package_name` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `modx_transport_providers` (
  ...
  `api_key` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `created` datetime NOT NULL,
  `updated` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `modx_transport_providers` VALUES (1,'modx.com','The official MODX transport provider for 3rd party components.','https://rest.modx.com/extras/','','','2018-07-11 19:07:48',NULL,1,10,'');
...
CREATE TABLE `modx_user_attributes` (
  ...
  `city` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  `photo` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `comment` text COLLATE utf8_unicode_ci NOT NULL,
  `website` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
INSERT INTO `modx_user_attributes` VALUES (1,1,'Default Admin User','chester@smashstack.com','','',0,0,0,1,0,1541725436,0,'ip0hst4lv6ee7evfgqbctpg4m9',0,0,'','','','','','','','','',NULL);
...
CREATE TABLE `modx_users` (
  ...
  `active` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `remote_key` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `modx_users` VALUES (1,'admin','FKtxUSx3nZZTWgrXRqm69qQExhwYZHYaupGLCfQMG9w=','','modUser',1,NULL,NULL,'hashing.modPBKDF2','4420f7f2d5dc20041c754b3c2457a56d',1,NULL,1,1541725428);
...
CREATE TABLE `modx_workspaces` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `path` varchar(191) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `created` datetime NOT NULL,
...
INSERT INTO `modx_workspaces` VALUES (1,'Default MODX workspace','{core_path}','2018-11-09 01:03:44',1,NULL);
...
-- Dump completed on 2018-11-09  1:09:42
